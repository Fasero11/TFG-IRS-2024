...
def gl_6dof(map_global, scancloud, groundtruth, algorithm, version_fitness, err_dis,unif_noise):
    ...
    if (algorithm.type == 1): # Differential Evolution
        ...
        [pcAligned, estimate, bestCost, rmse_array, it] = pso_6dof(real_scan,map_global,mapmax, mapmin, err_dis, NPini, D ,w, wdamp, c1, c2, iter_max,version_fitness)
        ...
        [pcAligned, estimate, bestCost, rmse_array, it] = iwo_6dof(real_scan, map_global, mapmax, mapmin, err_dis, NPini, D , Smin, Smax, exponent, sigma_initial, sigma_final, iter_max, version_fitness)
